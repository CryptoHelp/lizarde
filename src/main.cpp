...
int64 nChainStartTime = 1405402411;
...
const string strMessageMagic = "Lizarde Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Lizarde
    bool fStrictPayToScriptHash = true; // Always active in Lizarde
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Lizarde", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Relaunch 7/15/2014";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xd7ddea96a0158b294fe5c46ec28fc5ff75a641f366409ee2077be525077ca6a5"));
...
unsigned char pchMessageStart[4] = { 0x26, 0x37, 0x48, 0x59 };
