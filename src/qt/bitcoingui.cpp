...
{
    resize(850, 550);
    setWindowTitle(tr("Lizarde") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
qApp->setStyleSheet("QMainWindow { background-image: url(:/images/bgsplatter);} QMenuBar { background: qlineargradient(spread:pad, x1:0.548, y1:0.0906818, x2:0.559322, y2:1, stop:0.711864 rgba(19, 194, 232, 243), stop:1 rgba(228, 255, 255, 255)); } QMenuBar::item {background-color: transparent; } QToolBar {  background-color: qlineargradient(spread:pad, x1:0.548, y1:0.0906818, x2:0.559322, y2:1, stop:0.711864 rgba(19, 194, 232, 243), stop:1 rgba(228, 255, 255, 255));}"); 
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Lizarde address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Lizarde"), this);
    aboutAction->setToolTip(tr("Show information about Lizarde"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Lizarde"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Lizarde client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Lizarde client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lizarde network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Lizarde address or malformed URI parameters."));
    }
